...
const products = [
  {
    ...
    image: 'https://static.vecteezy.com/system/resources/previews/009/264/644/non_2x/lms-learning-management-system-as-online-education-concept-educational-technology-online-learning-delivery-training-knowledge-software-application-qualification-framework-illustration-free-vector.jpg'
  },
  {
    id: 2,
    title: 'ADRS Gem Control',
  ...
  },
  {
    id: 3,
    title: 'ADRS CRM ',
    description: 'Our Customer Relationship Management (CRM) system helps businesses build stronger relationships with their customers, manage leads, and enhance sales efficiency.',
    detailedDescription: 'ADRS CRM Suite provides a complete solution to manage customer data, automate workflows, track interactions, and analyse customer behaviour. It helps teams improve productivity, streamline communication, and increase revenue through smart insights.',
    features: [
    ...
    image: 'https://winfor.es/wp-content/uploads/2022/06/CRM_-scaled.jpg'
  },
  {
    id: 4,
    title: 'ADRS Test Series Platform',
    description: 'A fully featured online Test Series system designed for coaching institutes, universities, and individual educators to manage and conduct exams efficiently.',
    detailedDescription: 'ADRS Test Series Platform enables institutes to create online test papers, schedule exams, and analyse student performance. With AI-based evaluation, instant ranking, and progress analytics, it provides a robust assessment experience for learners and administrators alike.',
    features: [
      'AI-based auto evaluation',
      'Subject-wise test creation',
      'Detailed analytics and rankings',
      'Time tracking and negative marking',
      'Responsive and mobile-friendly design'
    ],
    image: 'https://apnipathshala.com/wp-content/uploads/2024/05/Test-Series-Mobile-600x330.jpg'
  }
];
